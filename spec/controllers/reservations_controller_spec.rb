  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reservation as @reservation" do
        ...
        post :create, {:reservation => { "reservation_set_id" => "invalid value" }}, valid_session
        assigns(:reservation).should be_a_new(Reservation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reservation" do
        ...
        Reservation.any_instance.should_receive(:update_attributes).with({ "reservation_set_id" => "1" })
        put :update, {:id => reservation.to_param, :reservation => { "reservation_set_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reservation as @reservation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reservation.any_instance.stub(:save).and_return(false)
        put :update, {:id => reservation.to_param, :reservation => { "reservation_set_id" => "invalid value" }}, valid_session
        assigns(:reservation).should eq(reservation)
      end
